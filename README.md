# shell-scripting
Polishing my shell scripting skills by writing, automating & debugging various daily linux sys-admin tasks during the lockdown with the below courses from Udemy
